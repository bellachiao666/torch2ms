...
class _TorchStub:
    def __init__(self):
        self.autocast = types.SimpleNamespace()
    def get_autocast_dtype(self, device=None):
        return ms.float16
    def get_autocast_cpu_dtype(self):
        return ms.float16
    def get_autocast_gpu_dtype(self):
        return ms.float16
    def is_autocast_enabled(self, device=None):
        return False
    def is_autocast_cpu_enabled(self):
        return False


torch = _TorchStub()
F = types.SimpleNamespace(rms_norm=None)
