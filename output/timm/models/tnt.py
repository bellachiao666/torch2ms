...
class PixelEmbed(msnn.Cell):
    ...
    def construct(self, x: ms.Tensor, pixel_pos: ms.Tensor) -> ms.Tensor:
        B, C, H, W = x.shape
        _assert(
            H == self.img_size[0],
...
class TNT(msnn.Cell):
    ...
    def forward_intermediates(
        ...
        patch_embed = mint.cat((self.cls_token.expand(B, -1, -1), patch_embed), dim = 1)
