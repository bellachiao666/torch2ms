...
class SimpleViT(msnn.Cell):
    ...
    def construct(self, img):
        ...
        freqs = torch.view_as_real(fft2(img))  # 'torch.fft.fft2' 未在映射表(api_mapping_out_excel.json)中找到，需手动确认;; 'torch.view_as_real' 未在映射表(api_mapping_out_excel.json)中找到，需手动确认;
...
if __name__ == '__main__':
    ...
    images = mint.randn(size = (8, 3, 256, 256))
